    ...
    <div id="main-content">
        ...
        <div id="isi">
            <center>
                ...
                <img src="foto/<?php echo $user['picture'];?>" alt="Profile Picture" style="height: 150px; display: block; margin: auto;"><br>
                <form action="foto_profil.php" method="post" enctype="multipart/form-data" style="border:solid #29aae3 1px; padding: 20px;width: 60%;">
