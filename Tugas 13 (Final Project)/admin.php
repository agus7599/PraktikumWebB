...
<body>
    <div id="main-content">
        ...
        <div id="isi">
                ...
                <button data-target="#create" data-toggle="modal" class="btn btn-success btn-lg btn-block">Input Admin Baru</button><br>
                <table style="text-align: left;padding:10px;width:100%;">
                    ...
                    while($pj = mysqli_fetch_assoc($result)){
                        echo "<tr>
                                ...
                                <td><a href=\"status_admin.php?id_user=".$pj['id_user']."&role=".$pj['role']."\">".($pj['role'] != 'admin' ? 'Aktifkan' : 'Nonaktifkan')."</a></td>
                            </tr>";
                    }
                    ?>
                </table>
