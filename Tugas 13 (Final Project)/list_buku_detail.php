    ...
    <div class=\"modal-content\">
      ...
      <div class=\"modal-body\">
        <table>
            <tr>
                <td>
                    <img style=\"width:250px;margin-right: 30px;\" src=\"foto/".$books['pic']."\">
                    <form action=\"foto_buku.php\" method=\"post\" enctype=\"multipart/form-data\">
                ...
                <td>
                    <form action=\"edit_buku.php\" method=\"post\" name=\"edit-buku\">
                    <input type=\"text\" name=\"id_buku\" value=\"".$books['id_buku']."\" hidden>
