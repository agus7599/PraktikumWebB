...
<body>
    <div id="main-content">
        ...
        <div id="isi">
            <h1>Data Buku</h1>
            <button data-target="#create" data-toggle="modal" class="btn btn-success btn-lg btn-block">Input Buku Baru</button><br>
    ...
    <?php
        require "buat_buku.php";
    ?>
    <?php
        $result = mysqli_query($database->koneksi, $query);
        while($books = mysqli_fetch_assoc($result)){
            require "list_buku_detail.php";
        }
    ?>
</body>
</html>